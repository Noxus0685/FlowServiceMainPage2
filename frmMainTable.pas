  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          FActiveWorkTable.CurrentPoint.Assign(Result, True);
          LoadDebugContext;
          DebugLog('CURRENT_POINT_RESTORED_FROM_FLOW_FALLBACK',
            Format('CurPointUUID=%s; CurDeviceTypePointUUID=%s; CurPointName=%s',
              [CurPointUUID, CurDeviceTypePointUUID, CurPointName]));
        end;
        Exit;
      end;
    end;
