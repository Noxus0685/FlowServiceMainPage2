...
begin
  ...
  try
    ...
    // Явно сохраняем редактируемый прибор после успешного DeviceEdit.
    // PersistDeviceAsync содержит защиту: прибор без SerialNumber не сохраняется.
    PersistDeviceAsync(ADevice);
