...
var
  ...
  PointIndex: Integer;
  MeasurementSegment, RunActive, NewRunStarted, PointChanged: Boolean;
begin
  if FFlowGraphHistory = nil then
    Exit;
  ...
  if (FGraphChannelsReady or (FActiveWorkTable <> nil)) and IsFlowGraphSamplingActive(FActiveWorkTable) and
