...
begin
  ...
  try
    ...
    MsgUser.AddPair('content',
      ...
      'Если в шаблоне передана modification, сначала ищи и используй таблицу для этой модификации; если такой таблицы нет — используй общую таблицу.' + sLineBreak +
...
begin
  Result :=
    ...
    '      "modification": "' + StringReplace(Trim(FType.Modification), '"', '\"', [rfReplaceAll]) + '",' + sLineBreak +
