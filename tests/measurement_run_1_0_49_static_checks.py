...
assert "BuildManualMeasurementPoint;" in start_body
...
assert "if NewMode = mrmManual then\n    BuildManualMeasurementPoint" not in switch_body
assert "MeasurementRun.InvalidatePreparedPoints" in MAIN
assert "APP_VERSION = '1.0.49'" in VERSION
