...
var
  ...
  var
    ...
    Node: TTreeViewItem;
  begin
    for J := TreeViewTypes.Count - 1 downto 0 do
    begin
      Node := TreeViewTypes.ItemByIndex(J);
      if (Node = nil) or (Node.Tag <> Ord(tnManufacturer)) then
        Continue;
      if Node.Count = 0 then
        TreeViewTypes.RemoveObject(Node);
    end;
  end;
begin
  ...
  try
    ...
    begin
      ...
      begin
        ...
        begin
          ManText := Trim(T.Manufacturer);
          ManKey  := Trim(T.Manufacturer);
        end
        else
        begin
