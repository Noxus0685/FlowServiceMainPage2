ICS - Internet Component Suite - V10.0 Beta - Delphi 7 to RAD Studio 12
=======================================================================
(Aka FPIETTE's Components)


Revised: December xx, 2024
Release: V10.0 Beta
...
Includes OpenSSL versions 3.0.15, 3.2.3, 3.3.2 and 3.4.0 for Win32 and Win64.

UPGRADE TO V10.0 AND LATER WARNINGS
-----------------------------------

V10 is a work in progress, not yet ready for testing!!!!
...
The latest released version is V9.3 which will be reported by the CopyRight constant
in OverbyteIcsWSocket.pas and the integer WSocketVersion as 903.

ICS V10 is in early development and is planned to support Android and Linux Server.
There are no current plans for ICS or iOS.
...
minor version of OpenSSL is linked into the application, 3013 is 3.0.13, or 31, 32 or 33.
ICS is currently distributed with OpenSSL 3.0, 3.2, 3.3 and 3.4, the latest patch of each
version so 3.4.0, 3.3.2, 3.2.3 and 3.0.15, the resources files are in .\Source\,
LibV34OpenSSL32.RES for 3.3 Win32, total eight resource files, ICS automatically links
...
for 3.4.0 in .\ICS-OpenSSL which are copied there when building the IcsCommonXXRun
...
OverbyteIcsDDWebService requires DDService framework to be installed from
