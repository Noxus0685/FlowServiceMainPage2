...
Mar 06, 2025 V9.5  Logging blacklist nows shows days if timestamp not
                     within 24 hours.
...
const
    CopyRight    : String     = ' TIcsBlacklist  (c) 2025 V10.0 ';
