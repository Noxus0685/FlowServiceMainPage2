ICS - Internet Component Suite - V9 - Delphi 7 to RAD Studio 11
===============================================================
(Aka FPIETTE's Components)

Revised: August 17, 2023
Release: V9.0
https://www.overbyte.be/
https://wiki.overbyte.be/
...
ICS contains over 100 sample applications developed over 25 years, most of the actively maintained
demos used to develop and test ICS for Windows VCL applications.


Pre-Built Samples
-----------------

All the above ICS active samples are available as prebuilt executables, to
...
YuOpenSSL to avoid DLL dependencies.  The zips include a few extra SSL
certificate and other files to support the samples.
