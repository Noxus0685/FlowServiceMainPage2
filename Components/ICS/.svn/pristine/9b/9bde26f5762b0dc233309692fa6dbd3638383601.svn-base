object HttpRestForm: THttpRestForm
  ...
  Top = 176
  Caption = 
    'ICS HTTPS REST and OAuth Demo - https://www.overbyte.eu  - 3 Apr' +
    'il 2025'
  ClientHeight = 741
  ClientWidth = 1000
  Color = clBtnFace
  ...
  object PageControl1: TPageControl
    ...
    object TabREST: TTabSheet
      ...
      object SaveNonTextual: TCheckBox
        Left = 775
        Top = 210
        Width = 204
        Height = 18
        Caption = 'Prompt to Save Non-Textual Content'
        TabOrder = 19
      end
    end
    ...
    object TabOAuth: TTabSheet
      ...
      object GroupBoxOAuth: TGroupBox
        ...
        object OAuthOptNoSecret: TCheckBox
          Left = 349
          Top = 125
          Width = 206
          Height = 17
          Caption = 'Allow Blank Secret (needs Tenant)'
          TabOrder = 14
        end
      end
  ...
  object SslWebSocketCli1: TSslWebSocketCli
    ...
    OnWSFramesDone = SslWebSocketCli1WSFramesDone
    Left = 50
    Top = 465
  end
