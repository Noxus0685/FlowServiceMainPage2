...
Nov 06, 2024 V9.4  Moved TWSocketData to Types.
...
const
  WSockBufVersion    = 904;
  CopyRight : String = ' TWSockBuf (c) 1996-2024 Francois Piette V9.4 ';

type
//  TWSocketData = type Pointer;    V9.4 moved to types
...
function IncPtr(P : Pointer; N : Integer = 1): Pointer; {$IFDEF USE_INLINE} inline; {$ENDIF}
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
procedure TIcsBufferHandler.Write(const Data: TWSocketData; Len: Integer);
begin
    Write(Data, 0, Len);
end;
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
procedure TIcsBufferHandler.Write(const Data: TWSocketData; Offset: Integer;  Len : Integer);
var
    oBuffer  : TIcsBuffer;
    iOffset  : Integer;
    bMore    : Boolean;
