...
Mar 18, 2025 V9.5 If response has Content-Disposition header, report attachment file name,
...
const
    THttpRestVersion = 1000;
    CopyRight : String = ' TSslHttpRest (c) 2025 F. Piette V10.0 ';
