...
Mar 21, 2025 V9.5  Added client support for protocol v3.1.1.  Only v5 connect works, lots
                   ...
                   Conack for 3.1.1 and later returns SessionPresent flag if ClientId matched
                     one previously used, which perhaps means we don't need to subsribe again s
                     ince server stored last session.
                  ...
                  mtCONNACK     :
                    if FRxStream.Size = 2 then     { V3.1 and 3.1.1 }
                      ...
                      begin
                        ...
                        Mon('CONNACK Reason Code ' + IntToHex(Id));       // V9.5 tell user
...
begin
  if aCode < 16 then
    ...
    Mon ('Connection ' + IntToHex(aCode));    { v5 need more response names }
