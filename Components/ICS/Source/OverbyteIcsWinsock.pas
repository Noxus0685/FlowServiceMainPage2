...
Dec xx, 2024 V10.0 Updated for DEFINE ICS_NewMessaging that implements new cross platform
                   ...
                   Export several missing WsaxxEvent functions.
...
function WSAIoctl(s: TSocket; IoControlCode: DWORD; InBuffer: Pointer; InBufferSize: DWORD; OutBuffer: Pointer; OutBufferSize:
                        DWORD; var BytesReturned: DWORD; Overlapped: POverlapped; CompletionRoutine : FARPROC): Integer; stdcall;
...
{$EXTERNALSYM accept}
function GetAddrInfoA(NodeName: PAnsiChar; ServName: PAnsiChar; Hints: PADDRINFOA;  var AddrInfo: PADDRINFOA): Integer; stdcall;
{$EXTERNALSYM GetAddrInfoA}
function GetAddrInfoW(NodeName: PWideChar; ServName: PWideChar; Hints: PADDRINFOW; var AddrInfo: PADDRINFOW): Integer; stdcall;
{$IFDEF UNICODE}
function GetAddrInfo(NodeName: PWideChar; ServName: PWideChar; Hints: PADDRINFOW;  var AddrInfo: PADDRINFOW): Integer; stdcall;
{$ELSE}
function GetAddrInfo(NodeName: PAnsiChar; ServName: PAnsiChar; Hints: PADDRINFOA; var AddrInfo: PADDRINFOA): Integer; stdcall;
{$ENDIF}
...
function GetNameInfoA(addr: PSockAddr; namelen: Integer; host: PAnsiChar; hostlen: DWORD; serv: PAnsiChar; servlen: DWORD; flags: Integer): Integer; stdcall;
{$EXTERNALSYM GetNameInfoA}
function GetNameInfoW(addr: PSockAddr; namelen: Integer; host: PWideChar; hostlen: DWORD; serv: PWideChar; servlen: DWORD; flags: Integer): Integer; stdcall;
{$EXTERNALSYM GetNameInfoW}
{$IFDEF UNICODE}
function GetNameInfo(addr: PSockAddr; namelen: Integer; host: PWideChar; hostlen: DWORD; serv: PWideChar; servlen: DWORD; flags: Integer): Integer; stdcall;
{$ELSE}
function GetNameInfo(addr: PSockAddr; namelen: Integer; host: PAnsiChar; hostlen: DWORD; serv: PAnsiChar; servlen: DWORD; flags: Integer): Integer; stdcall;
{$ENDIF}
...
function Ics_WSAAsyncGetHostByName(HWindow: HWND; wMsg: u_int; name, buf: PAnsiChar; buflen: Integer): THandle;
function Ics_WSAAsyncGetHostByAddr(HWindow: HWND; wMsg: u_int; addr: PAnsiChar; len, Struct: Integer; buf: PAnsiChar; buflen: Integer): THandle;
function Ics_WSAAsyncSelect(s: TSocket; HWindow: HWND; wMsg: u_int; lEvent: Longint): Integer;

function Ics_WSAWaitForMultipleEvents(cEvents : DWORD; const lphEvents: PWSAEVENT; fWaitAll : Bool; dwTimeout : DWORD; fAlertable : Bool) : DWORD;  { V9.4 WsaxxEvent }
function Ics_WSAEnumNetworkEvents(s: TSocket; hEventObject: WSAEVENT; var lpNetworkEvents: WSANETWORKEVENTS): Integer;
function Ics_WSACreateEvent : TWSAEVENT;
function Ics_WSASetEvent(hEvent : TWSAEVENT) : BOOL;
function Ics_WSAResetEvent(hEvent : TWSAEVENT) : BOOL;
function Ics_WSACloseEvent(hEvent : TWSAEVENT) : BOOL;
function Ics_WSAEventSelect(s: TSocket; hEventObject : TWSAEVENT; lNetworkEvent: LongInt) : Integer;
...
function Ics_setsockopt(s: TSocket; level, optname: Integer; optval: PAnsiChar;  optlen: Integer): Integer;
function Ics_getsockopt(s: TSocket; level, optname: Integer; optval: PAnsiChar;  var optlen: Integer): Integer;
function Ics_sendto(s: TSocket; var Buf; len, flags: Integer; var addrto: TSockAddr; tolen: Integer): Integer;
...
function Ics_recvfrom(s: TSocket; var Buf; len, flags: Integer; var from: TSockAddr; var fromlen: Integer): Integer;
...
function Ics_WSAIoctl(s: TSocket; IoControlCode: DWORD; InBuffer: Pointer; InBufferSize: DWORD; OutBuffer: Pointer;
...
function Ics_GetAddrInfoA(NodeName: PAnsiChar; ServName: PAnsiChar; Hints: PADDRINFOA; var AddrInfo: PADDRINFOA): Integer;
function Ics_GetAddrInfoW(NodeName: PWideChar; ServName: PWideChar; Hints: PADDRINFOW; var AddrInfo: PADDRINFOW): Integer;
{$IFDEF UNICODE}
function Ics_GetAddrInfo(NodeName: PWideChar; ServName: PWideChar; Hints: PADDRINFOW; var AddrInfo: PADDRINFOW): Integer;

{$ELSE}
function Ics_GetAddrInfo(NodeName: PAnsiChar; ServName: PAnsiChar; Hints: PADDRINFOA; var AddrInfo: PADDRINFOA): Integer;
{$ENDIF}
...
{$ENDIF}
function Ics_GetNameInfoA(addr: PSockAddr; namelen: Integer; host: PAnsiChar; hostlen: DWORD; serv: PAnsiChar; servlen: DWORD; flags: Integer): Integer;
function Ics_GetNameInfoW(addr: PSockAddr; namelen: Integer; host: PWideChar; hostlen: DWORD; serv: PWideChar; servlen: DWORD; flags: Integer): Integer;
{$IFDEF UNICODE}
function Ics_GetNameInfo(addr: PSockAddr; namelen: Integer; host: PWideChar; hostlen: DWORD; serv: PWideChar; servlen: DWORD; flags: Integer): Integer;
{$ELSE}
function Ics_GetNameInfo(addr: PSockAddr; namelen: Integer; host: PAnsiChar; hostlen: DWORD; serv: PAnsiChar; servlen: DWORD; flags: Integer): Integer;
{$ENDIF}
...
type
    ...
    TWSAAsyncGetHostByName = function (HWindow: HWND; wMsg: u_int; name, buf: PAnsiChar; buflen: Integer): THandle; stdcall;
    TWSAAsyncGetHostByAddr = function (HWindow: HWND; wMsg: u_int; addr: PAnsiChar; len, Struct: Integer; buf: PAnsiChar;
                                                                                          buflen: Integer): THandle; stdcall;
    TWSAAsyncSelect        = function (s: TSocket; HWindow: HWND; wMsg: u_int; lEvent: Longint): Integer; stdcall;

    TWSAWaitForMultipleEvents = function (cEvents : DWORD; const lphEvents : PWSAEVENT; fWaitAll : Bool; dwTimeout : DWORD;
                                                                                              fAlertable : Bool) : DWORD; stdcall;     { V10.0 }
    TWSAEnumNetworkEvents  = function (s: TSocket; hEventObject: WSAEVENT; var lpNetworkEvents: WSANETWORKEVENTS): Integer; stdcall;   { V10.0 }
    TWSACreateEvent        = function : DWORD; stdcall;                                           { V10.0 }
    TWSASetEvent           = function (hEvent : TWSAEVENT) : BOOL; stdcall;                       { V10.0 }
    TWSAResetEvent         = function (hEvent : TWSAEVENT) : BOOL; stdcall;                       { V10.0 }
    TWSACloseEvent         = function (hEvent : TWSAEVENT) : BOOL; stdcall;                       { V10.0 }
    TWSAEventSelect        = function (s: TSocket; hEventObject : TWSAEVENT; lNetworkEvent: LongInt) : Integer; stdcall;  { V10.0 }
    ...
    TGetSockOpt            = function (s: TSocket; level, optname: Integer; optval: PAnsiChar;  var optlen: Integer): Integer; stdcall;
    TSendTo                = function (s: TSocket; var Buf; len, flags: Integer; var addrto: TSockAddr; tolen: Integer): Integer; stdcall;
    ...
    TIoctlSocket           = function (s: TSocket; cmd: DWORD; var arg: u_long): Integer; stdcall;
    TWSAIoctl              = function (s: TSocket; IoControlCode: DWORD; InBuffer: Pointer; InBufferSize: DWORD; OutBuffer: Pointer;
                OutBufferSize: DWORD; var BytesReturned : DWORD; Overlapped: POverlapped; CompletionRoutine : FARPROC): Integer; stdcall;
    ...
    TAccept                = function (s: TSocket; addr: PSockAddr; addrlen: PInteger): TSocket; stdcall;
    TGetAddrInfoA          = function(NodeName: PAnsiChar; ServName: PAnsiChar; Hints: PAddrInfoA; var Addrinfo: PAddrInfoA): Integer; stdcall;
    TGetAddrInfoW          = function(NodeName: PWideChar; ServName: PWideChar; Hints: PAddrInfoW; var Addrinfo: PAddrInfoW): Integer; stdcall;
    TFreeAddrInfoA         = procedure(ai: PAddrInfoA); stdcall;
    TFreeAddrInfoW         = procedure(ai: PAddrInfoW); stdcall;
    TGetNameInfoA          = function(addr: PSockAddr; namelen: Integer; host: PAnsiChar; hostlen: DWORD; serv: PAnsiChar;
                                                                                servlen: DWORD; flags: Integer): Integer; stdcall;
    TGetNameInfoW          = function(addr: PSockAddr; namelen: Integer; host: PWideChar; hostlen: DWORD; serv: PWideChar;
                                                                               servlen: DWORD; flags: Integer): Integer; stdcall;
var
   ...
   FWSAWaitForMultipleEvents : TWSAWaitForMultipleEvents = nil;
   FWSAEnumNetworkEvents     : TWSAEnumNetworkEvents = nil;     { V10.0 }
   FWSACreateEvent           : TWSACreateEvent = nil;
   FWSASetEvent              : TWSASetEvent = nil;
   FWSAResetEvent            : TWSAResetEvent = nil;
   FWSACloseEvent            : TWSACloseEvent = nil;
   FWSAEventSelect           : TWSAEventSelect = nil;
    ...
    try
        if GWsDLLHandle = 0 then begin
            ...
            if GWsDLLHandle = 0 then
                raise Exception.Create('Unable to load ' + GWsDLLName + ' - ' + SysErrorMessage(GetLastError));
            LastError := Ics_WSAStartup(MAKEWORD(GReqVerLow, GReqVerHigh), GInitData);
            if LastError <> 0 then
                raise ESocketAPIException.Create('Winsock startup error ' + GWs2DLLName + ' - ' + GetWinsockErr (LastError));
        end;
        if Length(ProcName) = 0 then
            ...
            if Result = nil then
                raise ESocketAPIException.Create('Procedure ' + String(ProcName) + ' not found in ' + GWsDLLName + ' - ' + SysErrorMessage(GetLastError));
        end;
    finally
    ...
    try
        if GWs2DLLHandle = 0 then begin
            ...
            if GWs2DLLHandle = 0 then
                raise Exception.Create('Unable to load ' + GWs2DLLName + ' - ' + SysErrorMessage(GetLastError));
        end;
        if Length(ProcName) = 0 then
            Result := nil
        else begin
            ...
            if Result = nil then
                raise ESocketAPIException.Create('Procedure ' + String(ProcName) + ' not found in ' + GWs2DLLName + ' - ' + SysErrorMessage(GetLastError));
        end;
    finally
        LeaveCriticalSection(GWSockCritSect);
    end;
        ...
        if GWs2IPv6ProcHandle = 0 then begin
            ...
            if @FGetAddrInfoA = nil then begin
                ...
                if GWship6DllHandle = 0 then
                    raise Exception.Create('Unable to load ' + GWship6DLLname + ' - ' + SysErrorMessage(GetLastError));
...
begin
    ...
    try
        if (GWsDLLHandle <> 0) and (WSocketGCount = 0) then begin
            ...
            FWSAAsyncSelect        := nil;
            FWSAWaitForMultipleEvents := nil;    { V9.4 }
            FWSAEnumNetworkEvents     := nil;
            FWSACreateEvent           := nil;
            FWSASetEvent              := nil;
            FWSAResetEvent            := nil;
            FWSACloseEvent            := nil;
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
function WSAIoctl(s: TSocket; IoControlCode: DWORD; InBuffer: Pointer; InBufferSize: DWORD; OutBuffer: Pointer;
    OutBufferSize: DWORD; var BytesReturned: DWORD; Overlapped: POverlapped; CompletionRoutine: FARPROC): Integer; stdcall;
begin
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
function Ics_WSAWaitForMultipleEvents(
    cEvents : DWORD;
    const lphEvents : PWSAEVENT;
    fWaitAll : Bool;
    dwTimeout : DWORD;
    fAlertable : Bool) : DWORD;
begin
    if @FWSAWaitForMultipleEvents = nil then
        @FWSAWaitForMultipleEvents := GetProc2('WSAWaitForMultipleEvents');
    Result := FWSAWaitForMultipleEvents(cEvents, lphEvents, fWaitAll, dwTimeout, fAlertable);
end;


{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
function Ics_WSAEnumNetworkEvents(
    s: TSocket;
    hEventObject: WSAEVENT;
    var lpNetworkEvents: WSANETWORKEVENTS): Integer;
begin
    if @FWSAEnumNetworkEvents = nil then
        @FWSAEnumNetworkEvents := GetProc2('WSAEnumNetworkEvents');
    Result := FWSAEnumNetworkEvents(s, hEventObject, lpNetworkEvents);
end;
...
function Ics_WSACreateEvent : TWSAEVENT;
begin
    if @FWSACreateEvent = nil then
        @FWSACreateEvent := GetProc2('WSACreateEvent');
...
function Ics_WSACloseEvent(hEvent : TWSAEVENT) : BOOL;
begin
    if @FWSACloseEvent = nil then
        @FWSACloseEvent := GetProc2('WSACloseEvent');
    Result := FWSACloseEvent(hEvent);
end;
...
function Ics_WSASetEvent(hEvent : TWSAEVENT) : BOOL;
begin
    if @FWSASetEvent = nil then
        @FWSASetEvent := GetProc2('WSASetEvent');
    Result := FWSASetEvent(hEvent);
end;
...
function Ics_WSAResetEvent(hEvent : TWSAEVENT) : BOOL;
begin
    if @FWSAResetEvent = nil then
        @FWSAResetEvent := GetProc2('WSAResetEvent');
    Result := FWSAResetEvent(hEvent);
end;


{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
function Ics_WSAEventSelect(
    s             : TSocket;
    hEventObject  : TWSAEVENT;
    lNetworkEvent : LongInt) : Integer;
begin
    if @FWSAEventSelect = nil then
        @FWSAEventSelect := GetProc2('WSAEventSelect');
//    OutputDebugString(PChar(Format('Ics_WSAEventSelect SizeOf(Socket)=%d  SizeOf(hEventObject)=%d  SizeOf(lNetworkEvent)=%d',
//                                   [SizeOf(s), SizeOf(hEventObject), SizeOf(lNetworkEvent)])));
    Result := FWSAEventSelect(s, hEventObject, lNetworkEvent);
end;
