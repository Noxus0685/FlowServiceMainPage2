...
Dec 09, 2020 V8.65 Use AtomicIncrement instead of InterlockedIncrement.
                   Renamed Ics.Posix.Messages.pas to Ics.Posix.PXMessages.pas
Jan 25, 2023 V8.71 Using Int64 ticks.
Aug 08, 2023 V9.0  Updated version to major release 9.
Oct 30, 2024 V10.0 Now only used for Windows with old Windows messaging, no Posix
...
var
{$IFDEF MSWINDOWS}  // otherwise a const in Ics.Posix.PXMessages
                ...
                begin
                    ...
                    try
                        for I := 0 to L.Count - 1 do begin
                            ...
                            else if (IcsDiffTicks64(CurTimer.FQueuedTicks, CurTicks) >= CurTimer.Interval) then begin   { V8.71 }
...
begin
    ...
    try
        ...
        try
            ...
            TimerObj.FQueuedTicks := IcsGetTickCount64;      { V8.71 }
...
//    FUID   := InterlockedIncrement(GTimerID);
    FUID   := AtomicIncrement(GTimerID);          { V8.65 uses compiler magic if available }
