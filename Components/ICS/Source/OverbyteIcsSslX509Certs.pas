...
Mar 24, 2025 V9.5  Removed CertCentre Json ordering, now integrated into Digicert CertCentral
                     which supports Acmev2.
...
const
    SupplierProtoLits: array[TSupplierProto] of String =
        ('None', 'Own CA', 'AcmeV2', 'CertCentre', 'Servertastic' );     {  { V9.5 CertCentre gone, Servtas never supported }

 { V9.5 Acme protocol supplier, now supported by most certificate providers, often with a test envrionment }
    AcmeSupplierLits: array[0..10{TAcmeSupplier}] of String =
        ('Lets Encrypt Live','Lets Encrypt Testing','Bypass Live', 'Bypass Testing',
         'ZeroSSL','Google Live','Google Testing','Digicert Live','Digicert Testing',
