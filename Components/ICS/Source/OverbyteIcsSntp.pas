...
const
    CopyRight    : String     = ' O4erbyteIcsSntp (c) 2024 V10.0 ';

type
    TTimeProtocol = (tpSNTP, tpTCP, tpUDP, tpRoughTime);
    TTimeProtoSet = set of TTimeProtocol;

    TTimeQuery = procedure (Sender: TObject; SocketAddr : TSockAddrIn; TimeProtocol : TTimeProtocol; var Continue : Boolean) of object;
