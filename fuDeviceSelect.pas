...
begin
  ...
  if (Action <> TCloseAction.caNone) and (ModalResult <> mrOk) and
     FRequireSerialWarning and (Trim(FRequiredTypeUUID) <> '') and
     (not HasSavedDeviceForType(FRequiredTypeUUID)) then
