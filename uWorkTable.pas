...
{ TODO HYDRAULIC-SCHEME:
  ...
  При будущей интеграции гидравлической схемы результат выбора строки
  гидравлической схемы также должен завершаться тем же механизмом уведомлений:
  ...
  UI не должен знать, каким способом были выбраны эталоны:
    - по диапазонам и Group;
    - или по гидравлической схеме.

  Для интерфейса единственный сигнал обновления:
    ewtEtalonsChanged.
  ...
  Риск сохранения:
    ...
    сохраненной настройкой. В будущем желательно разделить Channel.Enabled
