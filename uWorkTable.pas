...
var
  ...
  begin
    ...
    begin
      ...
      TargetFlow := BaseFlow * (1 + AChannel.SimulationDirection * 0.03);
      TargetImpSec := FlowRateToImpSec(AWorkTable, AChannel, FlowFromBaseUnits(TargetFlow));
      if Abs(TargetImpSec - AChannel.ImpSec) < 1 then
      begin
      ...
      Exit((AChannel.SimulationTargetImpSec - AChannel.ImpSec) * 0.15 + ((Random - 0.5) * 0.2));
    end
    else
